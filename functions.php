...
{
    wp_enqueue_script('owl-default', 'https://cdn.jsdelivr.net/gh/alsafeerdev/main_web@main/includes/js/min/owl.carousel.min.js', array('jquery'), true, true);
    wp_enqueue_script('owl-call', 'https://cdn.jsdelivr.net/gh/alsafeerdev/main_web@main/includes/js/min/owl-call.min.js', array('owl-default'), true, true);
}
...
function add_custom_css()
{
    ...
    wp_enqueue_style('combines-styles', 'https://cdn.jsdelivr.net/gh/alsafeerdev/main_web@main/includes/css/min/combine.min.css', true, true,);
}
...
{
    wp_enqueue_script('synced-slider-scripts', 'https://cdn.jsdelivr.net/gh/alsafeerdev/main_web@main/includes/js/min/synced-slider.min.js', array('owl-default'), true, true);
    ob_start();
...
{
    wp_enqueue_script('image-optimize-js', 'https://cdn.jsdelivr.net/gh/alsafeerdev/main_web@main/includes/js/min/image-optimize.min.js', false, false);
}
...
{
    wp_enqueue_style( 'media-queries', get_stylesheet_directory_uri() . '/includes/css/min/media.min.css', true , '(max-width: 1920px)' );

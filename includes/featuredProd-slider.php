            ...
            <div class="feat-prods-container bg-white text-center">
                <a href="<?php echo get_permalink(); ?>" class="feat-prods-wrapper-link" target="_blank">
                    ...
                    <div class="feat-prods-content-container">
                        ...
                        <p class="feat-prods-know-more letter-spacing-0-5">Learn More</p>
                    </div>
                </a>
            </div>
        <?php endwhile; ?>
...
<!-- Custom Navigation -->
<div class="next-btn-feat-prod light feat-prods-cust-nav">
...
<div class="prev-btn-feat-prod rotate-180 light feat-prods-cust-nav">
